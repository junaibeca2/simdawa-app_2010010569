                    ...
                    <div class="card-body">
                        <form action="" method="post">
                            <div class="form-group row">
                                ...
                                <div class="col-md-10">
                                    <input type="text" name="nama_persyaratan" id="nama" class="form-control" required placeholder="Nama Persyaratan Beasiswa">
                                </div>
                            </div>
                            <div class="form-group row">
                                <label for="ket" class="col-md-2">Keterangan</label>
                                <div class="col-md-10">
                                    <input type="text" name="keterangan" id="ket" class="form-control" required placeholder="Keterangan">
                                </div>
                            </div>
