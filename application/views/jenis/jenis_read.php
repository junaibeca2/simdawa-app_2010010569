        ...
        <div class="row">
            <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                ...
                <div class="page-header">
                    <h2 class="pageheader-tittle">Data Jenis Beasiswa </h2>
                        ...
                        <table class="table table-bordered" id="mytabel">
                            ...
                            <tbody>
                                ...
                                foreach ($jenis as $a) {
                                    ...
                                    <td>" . $a->nama_jenis . "</td>
                                    <td>" . $a->keterangan . "</td>
                                    <td><a href=" . base_url('jenis/ubah/' . $a->id) . " class='btn btn-sm btn-info'><i class='fas fa-edit'>
                                    </i> Ubah</a>
                                    <a href=" . base_url('jenis/hapus/' . $a->id) . " onclick='return confirm(\"ingin hapus data ini?\")' class='btn btn-sm btn-danger'><i class='fas fa-trash'>
                                    </i> Hapus</a></td></tr>";
                                }
                                ?>
                            </tbody>
