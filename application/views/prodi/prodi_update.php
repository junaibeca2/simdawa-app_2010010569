                    ...
                    <div class="card-body">
                        <form action="" method="post">
                            ...
                            <div class="form-group row">
                                <label for="nama" class="col-md-2">Nama Prodi</label>
                                <div class="col-md-10">
                                    <input type="text" value="<?= $prodi->nama_prodi ?>" name="nama_prodi" id="nama" class="form-control" required placeholder="Nama Prodi">
                                </div>
                            </div>
